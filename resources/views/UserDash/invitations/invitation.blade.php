        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-right">
                        <form action="{{route('my-invitations.destroy',$invite->id)}}" method="post" class="float-right delete-form px-2">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger shadow Delete-Form">Delete</button>
                        </form>
                    <a href="{{route('my-invitations.edit',$invite->id)}}" class="create btn btn-light bg-white border shadow">Click & Edit</a>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="text">
                        ...
                        <p class="text-white">{{ucfirst($invite->quote)}}</p>                        
                    </div>
                </div>
            </div>
        </div>
...
<div class=" shadow container-flude border mt-3 mb-3 invi-date d-flex align-items-center" style="background-image: url({{asset('Template/img/preview/texture-glitter-elegant-christmas-sparkling-260nw-1674056632.jpg')}}">
    ...
    -->
<!-----------Birthady images----------->
    <div class="container images mt-5 bday-memorry bday-images" >    
        <div class="row">
            <div class="col-sm-12">
                <div class="image-heading text-center mb-2">
                    <span class="heading p-4">Birthday Memories</span>
                </div>
            </div>
        </div>
        <div class="row">
